...
fileHandler = logging.handlers.RotatingFileHandler('C:/python_project/log/' + hereWork + '_crawlerbot_logging_' + currTime, maxBytes=file_max_bytes, encoding='UTF-8', backupCount=10)
                ...
                try:
                    ...
                    if returnedPossibleScroll == True:
                        ...
                        if corpRecruitArticleTitle == corpJboArticleTitle:
                            ...
                            database_connection = mySQL_conn.DatabaseConnection()
